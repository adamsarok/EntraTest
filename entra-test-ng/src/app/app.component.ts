...
export class AppComponent implements OnInit, OnDestroy {
  ...
  login() {
    ...
    console.log({ ...this.msalGuardConfig.authRequest } as RedirectRequest);
    ...
    //   scopes: ['user.read'], // Add the necessary scopes here
    //   ...this.msalGuardConfig.authRequest // Merge with existing authRequest if applicable
    // };
